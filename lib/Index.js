...
var MongoBaseRepository_1 = require("./repositories/base/MongoBaseRepository");
var Cat_1 = require("./repositories/models/Cat");
var MONGO_OPTIONS = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                // connecting at mongoClient
                _a.sent();
                CatService = new MongoBaseRepository_1.MongoBaseRepository(Cat_1.Cat);
                catt = new Cat_1.Cat();
                catt.age = 11;
                catt.color = '112a';
                return [4 /*yield*/, CatService.create(catt)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
